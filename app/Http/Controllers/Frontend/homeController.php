...
{
    $contacts = Contact::all(); // Get all contacts or add pagination if needed
    return view('Frontend.pages.contactUs.receive', compact('contacts'));
}
...
public function deleteContact($id)
{
    ...
    return redirect()->route('contacts.receive'); // Redirect to the contacts list page
}
