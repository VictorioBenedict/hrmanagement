...
@section('content')
   ...
   .pagination .page-item:not(.disabled) .page-link:hover {
    ...
    <h6 class="text-uppercases"style="color:#AE7DAC;">Update Action Type</h6>
</div><br>
    <!--Section: Form Design Block-->
    <section>
            ...
            <div class="text-left w-50 ">
                <div class="card  mb-3">
                    <div class="card-header py-3">
                        <h5 class="text-uppercases">Update Action Form</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('leave.leaveType.update', $leaveType->id) }}" method="post">
                            ...
                            <div class="text-center w-25 mx-auto">
                                <a href="{{ route('leave.leaveType') }}" class="btn btn-danger p-2 px-3 rounded-pill">Cancel</a>
                            </div>
                            </div>
