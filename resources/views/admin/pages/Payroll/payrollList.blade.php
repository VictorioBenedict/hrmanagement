...
<div class="my-5 py-5">
    <div class="d-flex justify-content-between align-items-center mb-5">
        ...
        <a href="{{ route('allPayrollList') }}" class="btn btn-danger text-capitalize border-0" data-mdb-ripple-color="dark">Report</a>
    </div>

    <div class="table-responsive">
        <table class="table align-middle text-center w-100 table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-warning rounded-pill" href="{{ route('payrollEdit', $payroll->id) }}">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>

                        <a class="btn btn-danger rounded-pill" href="{{ route('payrollDelete', $payroll->id) }}">
    ...
    <div class="w-25 mx-auto">
        {{-- Pagination or other UI elements can go here --}}
    </div>
</div>
