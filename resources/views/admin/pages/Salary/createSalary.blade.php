...
<div class="shadow p-3 d-flex justify-content-between align-items-center">
    <h6 class="text-uppercase">Create Salary</h6>
    <div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-outline">
                                        ...
                                        <input required placeholder="Mobile Allowance" type="number" id="mobileAllowance"
                                ...
                                <div class="col-md-4">
                                    <div class="form-outline">
                                        ...
                                        <input required placeholder="House Rent Allowance" type="number" 
...
{{-- Optional JavaScript (for dynamically setting salary values based on class) --}}
{{-- <script>
